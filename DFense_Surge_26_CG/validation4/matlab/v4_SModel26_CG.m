% LNCC SURGE Model 26  Chikungunya- Validation 4
...
% 4) Provide a 'Validation 4' Forecast based on the model of the average surge
...
ind_EW25_2025=441+52+52+52; % time index of EW 25 of 2025 
...
P_est(3)=round(P_est(3)); % rounds estimated n0, since it is supposed
% to be an integer 
...
for kk=1:ns
    ...
    if isnan(cross_corr_coef)
        ...
        g(kk)=a'*x./(x'*x);   % calculates amplitude gain for 
        % each observed surge at column kk
    end
end
...
mg=param(1);  % mean of value of g (from 2014 to 2025)
sigma=param(2); % standard deviation of value of g (from 2014 to 2025)
...
writetable(T,['..\spreadsheets\v4_SModel26_CG_',...
...
% from EW 41 2025 up to EW 52 of 2026
hold on;
...
print(['..\plots\v4_SModel26_CG_',UF],'-dpdf')
