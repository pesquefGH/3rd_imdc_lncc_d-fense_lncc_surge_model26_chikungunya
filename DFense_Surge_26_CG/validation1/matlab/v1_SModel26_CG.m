% LNCC SURGE Model 26  Chikungunya- Validation 1
...
% 4) Provide a 'Validation 1' Forecast based on the model of the average surge
...
ind_EW25_2022=441; % time index of EW 25 of 2022 
...
dcasesfs=dcasesf(41:ind_EW25_2022);  % selects filtered data from EW 41/2014 to EW 25/2022
...
mg=param(1);  % mean of value of g (from 2014 to 2022)
sigma=param(2); % standard deviation of value of g (from 2014 to 2022)
...
writetable(T,['..\spreadsheets\v1_SModel26_CG_',num2str(state_code(1)),'.csv'],'Delimiter',',')
...
print(['..\plots\v1_SModel26_CG_',UF],'-dpdf')
